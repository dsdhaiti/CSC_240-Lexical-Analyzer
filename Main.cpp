...
int lex() {
	...
	case LETTER:
		// adds the next character to the lexum array
		addChar();

		// will define them as
		// will either be identified as a:
		// INTEGER
		// Letter
		// UNKNOWN
		getChar();
		...
		/////////////////////////////////////////////////////////////////////////////
		// if it is an iff statment then do this
		if (lexeme[0] == 'i' && lexeme[2] == 'f')
		{
			// it is an if statement

			// runs the iff statment function
			//<if_stmt>



		}/*can expand and add different funcitons here (ex while, do, )*/
		else /* else if itis not an if statment then continue bringring in the cahracter value */
		{
